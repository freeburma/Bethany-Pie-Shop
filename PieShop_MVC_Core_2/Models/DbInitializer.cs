...
{
    /*
        This class will Initialize the database. 
     */
    ...
    public static class DbInitializer
    {
        ...
        /*
            This is inside the Startup.cs => Configure ()
         */
        ...
        public static Dictionary<string, Category> Categories
        {
            get
            {
                if (categories == null)
                {
                    ...
                    foreach (Category genere in genreList)
                    {
                        categories.Add(genere.CategoryName, genere);
                    }
                }
